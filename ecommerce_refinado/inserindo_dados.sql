...
INSERT INTO Cliente(primeiro_nome, inicial_s_nome, sobrenome, CPF, CNPJ, endereco)
VALUES ('Satoru', 'C', 'Gojo', '12345678900', '123456789012345', 'Shibuya'),
       ('Suguru', 'S', 'Geto', '98765432100', '987654321098765', 'Shibuya'),
       ('Itadori', 'K', 'Yuuji', '12312312300', '123123123123123', 'Tokyo'),
       ('Megumi', 'Z', 'Fushiguro', '45645645600', '456456456456456', 'Tokyo'),
       ('Nobara', 'C', 'Kugisaki', '78978978900', '789789789789789', 'Kyoto');
...
INSERT INTO Entrega(codigo_rastreio, idPedido, status)
VALUES ('ROFXN8', 1, 'processando'),
       ('QVO1B9', 2, 'entregue'),
       ('XWLUGF', 3, 'devolvido'),
       ('C6U8CS', 4, 'em trânsito'),
       ('38MYMR', 5, 'processando'),
       ('UZDY6K', 1, 'processando'),
       ('G4P4I4', 2, 'entregue'),
       ('0KQPHH', 3, 'devolvido'),
       ('CYZ2ZE', 4, 'em trânsito'),
       ('4UHB5U', 5, 'processando');
